                ...
                {products.map((item) => (
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity translate-x-4 group-hover:translate-x-0 transition-transform">
                            <button onClick={() => setViewingProduct(item)} className="p-3 bg-white text-black rounded-full shadow-xl hover:bg-black hover:text-white transition-colors"><Eye size={18}/></button>
                            <button onClick={() => startEdit(item)} className="p-3 bg-white text-yellow-600 rounded-full shadow-xl hover:bg-yellow-500 hover:text-white transition-colors"><Pencil size={18}/></button>
